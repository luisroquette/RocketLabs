# RocketLabs project comparison

[Library](../README.md) · [Português](../pt-BR/project-comparison.md)

Use this matrix to choose a starting point. Maintenance status does not replace
reading each project's requirements and license.
...
| Human control | review and approval stages | publishing-flow control |
| Start with | product tour and architecture | clean setup and editorial profile |

## Before reuse

1. Open the project's `LICENSE`.
2. Read requirements, variables and integrations.
3. Confirm external-service costs.
4. Run the primary path in an isolated environment.
5. Adapt brand and data without copying credentials or proprietary content.
