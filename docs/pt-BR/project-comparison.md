# Comparativo dos projetos RocketLabs

[Biblioteca](../README.md) · [English](../en/project-comparison.md)

Use esta matriz para escolher um ponto de partida. Estado de manutenção não
substitui a leitura dos requisitos e da licença de cada projeto.
...
| Controle humano | etapas de revisão e aprovação | controle do fluxo de publicação |
| Comece por | tour do produto e arquitetura | instalação limpa e perfil editorial |

## Antes de reutilizar

1. Abra o arquivo `LICENSE` do projeto.
2. Leia requisitos, variáveis e integrações.
3. Confirme custos de serviços externos.
4. Execute o caminho principal em ambiente isolado.
5. Adapte marca e dados sem copiar credenciais ou conteúdo proprietário.
